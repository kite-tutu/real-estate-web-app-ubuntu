...
class Property(TimeStampedUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        HOUSE = "House", _("House")
        APARTMENT = "Apartment", _("Apartmant")
    ...
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=100,default="234")
    street_address = models.CharField(verbose_name=_("Street Address"),max_length=150,default="Greg Anisha Street")
    property_number = models.IntegerField(verbose_name=_("Property Number"),validators=[MinValueValidator(1)],default=112)
    price = models.DecimalField(verbose_name=_("Price"),decimal_places=4, max_digits=8,default=0.00)
    tax = models.DecimalField(verbose_name=_("Property Tax"), max_digits=6,default=0.15,decimal_places=2,help_text="15% property tax charged")
