...
class Property(TimeStampedUUIDModel):
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="234"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Greg Anisha Street"
    )
    ...
    price = models.DecimalField(
        verbose_name=_("Price"), decimal_places=4, max_digits=8, default=0.00
    )
