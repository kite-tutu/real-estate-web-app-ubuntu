    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address', models.CharField(default='Greg Anisha Street', max_length=150, verbose_name='Street Address')),
                ...
                ('price', models.DecimalField(decimal_places=4, default=0.0, max_digits=8, verbose_name='Price')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartment', 'Apartmant'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='Other', max_length=50, verbose_name='Property Type')),
